        ...
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    ...
                    <ul class="mainMenu ">
                        <div class="d-flex mt-5 menu-mobile ">
                            <li><a class="  mt-5" href="<?= WEB_ROUTE.'?controllers=admin&view=liste.question'?>">Liste des question</a></li>
                        </div>
                        ...
                        <div class="d-flex mt-4 menu-mobile  ">
                            <li><a class=" " href="#">Supprimer</a></li>
                        </div>
                        <?php if (est_connect()):?>
                                <li class="nav-item active ml-auto mr-auto mt-5">
